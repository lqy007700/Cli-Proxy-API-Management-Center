...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  {
    fieldId: 'routingSessionAffinityCapacityPolicy',
    sectionId: 'network',
    labelKey: L('sections.network.session_affinity_capacity_policy'),
    hintKey: L('sections.network.session_affinity_capacity_policy_hint'),
    yamlKeys: ['routing', 'session-affinity-capacity-policy'],
    keywords: ['strict-wait', 'wait-then-switch', 'capacity'],
  },
  {
    fieldId: 'accountConcurrencyEnabled',
    sectionId: 'network',
    labelKey: L('sections.network.account_concurrency_enabled'),
    hintKey: L('sections.network.account_concurrency_enabled_desc'),
    yamlKeys: ['account-concurrency', 'enabled'],
    keywords: ['concurrency', 'queue', 'admission'],
  },
  {
    fieldId: 'accountConcurrencyMaxTotalWait',
    sectionId: 'network',
    labelKey: L('sections.network.account_concurrency_max_total_wait'),
    hintKey: L('sections.network.account_concurrency_max_total_wait_hint'),
    yamlKeys: ['account-concurrency', 'max-total-wait'],
    keywords: ['concurrency', 'queue', 'timeout'],
  },
  {
    fieldId: 'accountConcurrencyMaxAccountSwitches',
    sectionId: 'network',
    labelKey: L('sections.network.account_concurrency_max_account_switches'),
    hintKey: L('sections.network.account_concurrency_max_account_switches_hint'),
    yamlKeys: ['account-concurrency', 'max-account-switches'],
    keywords: ['concurrency', 'queue', 'switch'],
  },
  {
    fieldId: 'accountConcurrencyMaxTotalWaiters',
    sectionId: 'network',
    labelKey: L('sections.network.account_concurrency_max_total_waiters'),
    hintKey: L('sections.network.account_concurrency_max_total_waiters_hint'),
    yamlKeys: ['account-concurrency', 'max-total-waiters'],
    keywords: ['concurrency', 'queue', 'waiters'],
  },
  {
    fieldId: 'accountConcurrencyStore',
    sectionId: 'network',
    labelKey: L('sections.network.account_concurrency_store'),
    hintKey: L('sections.network.account_concurrency_store_hint'),
    yamlKeys: ['account-concurrency', 'store'],
